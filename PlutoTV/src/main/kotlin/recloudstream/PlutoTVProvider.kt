...
class PlutoTVProvider : MainAPI() {
    override var mainUrl = "https://pluto.tv"
    override var name = "PlutoTV"
    ...
    private fun cards(doc: org.jsoup.nodes.Document, base: String): List<SearchResponse> =
        doc.select("a[href]").mapNotNull { e ->
            ...
            if (!url.startsWith("http") || !url.contains("pluto.tv", true)) return@mapNotNull null
